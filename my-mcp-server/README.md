...
```bash
claude mcp add sales -- python /home/zukanopro/workspace/Lab/lab26/Day26-MCP-Tools-Integration/my-mcp-server/server.py
```
*Hoặc sử dụng đường dẫn tương đối từ thư mục repo:*
```bash
claude mcp add sales -- python ./my-mcp-server/server.py
```
